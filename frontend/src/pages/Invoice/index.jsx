...
const Invoice = ({ order, url }) => {
  const styles = StyleSheet.create({
    page: {
      ...
      background:
        'https://plus.unsplash.com/premium_photo-1670148434900-5f0af77ba500?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    },
